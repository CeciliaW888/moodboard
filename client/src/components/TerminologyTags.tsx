      ...
      >
        <AnimatePresence>
          {(isExpanded ? tags : tags.slice(0, 1)).map((tag, i) => (
            <motion.div
              ...
              className="group/tag flex items-center bg-stone-100/80 dark:bg-neutral-700/60 rounded-full px-2 py-0.5 cursor-default transition-colors hover:bg-stone-200 dark:hover:bg-neutral-600"
            >
              <span className="text-[10px] font-medium text-stone-600 dark:text-stone-300 mr-1">{tag.term}</span>
              <div className="flex items-center gap-0.5 opacity-100 md:opacity-0 md:group-hover/tag:opacity-100 transition-opacity">
                <button
                  ...
                  className="p-0.5 hover:text-stone-700 dark:hover:text-stone-200 text-stone-400"
        ...
        {!isExpanded && tags.length > 1 && (
          <button
            ...
            className="text-[10px] font-semibold text-stone-400 dark:text-stone-500 hover:text-stone-600 dark:hover:text-stone-300 px-1.5 py-0.5 rounded-full transition-colors"
